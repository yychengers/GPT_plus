  ...
  return (
    <Shell settings={settings}>
      <article className="mx-auto max-w-3xl py-8 lg:py-12">
        ...
        <div className="border border-[var(--line)] bg-[var(--panel)] p-5 shadow-sm">
          <div className="mb-3 inline-flex items-center gap-2 text-sm text-[var(--muted)]">
            <ExternalLink size={16} aria-hidden="true" />
            分享阅读页
          </div>
          <h1 className="text-3xl font-semibold leading-tight tracking-normal sm:text-4xl">{post.title}</h1>
